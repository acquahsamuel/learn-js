...
const numsFor = [9, 8, 7, 6, 5, 4, 3, 2, 1]

numsFor.forEach(function (n) {
  console.log(n)
})

const numbersMap = [20, 21, 22, 23, 24, 25, 26, 27]
...
const newBooks = books.map(function (singleBook, idx) {
  return singleBook.idx, singleBook.authors
})
...
const squarese = [1, 2, 3, 4, 5, 6, 7, 9]
...
const wordsLetter = ['dog', 'dig', 'log', 'bag', 'wag']
...
const votes = ['y', 'y', 'y', 'y', 'y', 'y', 'n', 'n', 'n', 'n']
